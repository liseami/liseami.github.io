...
function setHttpClientAndAgentOptions(config) {
    ...
    if (isAboveNodejs16) {
        var ref1, ref2;
        if (((ref1 = config.experimental) == null ? void 0 : ref1.enableUndici) && !((ref2 = config.experimental) == null ? void 0 : ref2.appDir) && isAboveNodejs18) {
            Log.warn(`\`enableUndici\` option is unnecessary in Node.js v${NODE_18_VERSION} or greater.`);
        } else {
            var ref3;
            global.__NEXT_USE_UNDICI = (ref3 = config.experimental) == null ? void 0 : ref3.enableUndici;
        }
...
function assignDefaults(dir, userConfig) {
    ...
    if ((ref11 = result.experimental) == null ? void 0 : ref11.appDir) {
    ...
    if (result.basePath !== "") {
        ...
        if (result.basePath !== "/") {
            ...
            if (((ref7 = result.amp) == null ? void 0 : ref7.canonicalBase) === "") {
    ...
    if (result == null ? void 0 : result.images) {
        ...
        if (images.domains) {
            ...
            // this resource
            if ((ref10 = config.assetPrefix) == null ? void 0 : ref10.startsWith("http")) {
        ...
        const remotePatterns = result == null ? void 0 : (ref8 = result.images) == null ? void 0 : ref8.remotePatterns;
        if (remotePatterns) {
        ...
        const unoptimized = result == null ? void 0 : (ref9 = result.images) == null ? void 0 : ref9.unoptimized;
    ...
    if ((ref4 = result.experimental) == null ? void 0 : ref4.swcMinifyDebugOptions) {
    ...
    if ((ref6 = result.devIndicators) == null ? void 0 : ref6.buildActivityPosition) {
